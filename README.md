...
| product_type            | Product line of the product sold        | VARCHAR(100)   |
| unit_price              | The price of each product               | DECIMAL(10, 2) |
| quantity                | The amount of the product sold          | INT            |
| VAT                 | The amount of 12% tax on the purchase       | FLOAT(6, 4)    |
| Revenue                  | The total cost of the purchase          | DECIMAL(10, 2) |
...
> Conduct analysis on the data to understand the different product lines, the product types performing best, and the product types that need to be improved.
...
> 4. Created many virtual tables(Views) for effective and efficient analysis.
...
3. What is the most selling product type?
...
For the rest of the code, check the [SQL_queries.sql](https://github.com/Harshitaahra31/Walmart_Sales_Analysis-/blob/main/Walmart_Queries.sql) file
